...
West</a>.</p>`;
    ...
    /**
     * Modify the theme after loading and replace some area features with the
     * [[StandardTexturedTechnique]] to render them with textures and lighting.
     * This could solely be done in the theme json file but for explanatory resons it's done here.
    ...
    function modifyTheme(theme: Theme): Theme {
        ...
        const urbanAreaTexture = childUrlResolver("wests_textures/paving 2.png");
        const parkTexture = childUrlResolver("wests_textures/clover 1.png");
